...
def get_args():
    ...
    parser.add_argument('-ir', '--imageResolution', type=int, default=32, help='Image resolution (default: 32)')
    parser.add_argument('-p', '--lowerResolutionProb', type=float, default=0.5, help='Lower resolution prob(default: 0.5)')
    parser.add_argument('-is', '--indicesStep', type=int, default=100, help='Indices step (default: 100)')
    parser.add_argument('-spt', '--trainValidSplit', type=float, default=0.1, help='Indices step (default: 0.1)')
